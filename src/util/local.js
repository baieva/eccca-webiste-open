...
const strings = new LocalizedStrings({
  en: {
    ...
    etransfer1: "The ECCCA accepts donations and payment for membership fees and fund-raising events by etransfer.",
    etransfer2: "Sending and receiving an Interac e-Transfer through online banking:",
    etransfer3: "Senders",
    etransfer4: "•	Provide the name and email address / mobile phone of the recipient",
    etransfer5: "•	Enter a security question only the recipient will be able to answer",
    etransfer6: "•	Specify the amount and desired account for the payment",
    etransfer7: "•	An email notification will be automatically sent to the recipient",
    etransfer8: "Recipients",
    etransfer9: "•	Using a link on the email or text notification, you can access a secure online banking page",
    etransfer10: "•	Answer your security question and deposit the funds into one of your accounts",
    president:"President",
  ...
  ch: {
    ...
    langTag: "語言",
    aboutPayment: "關於支付",
    etransfer1: "ECCCA 通過電子轉賬接受捐款和支付會員費和籌款活動。",
    etransfer2: "通過網上銀行發送和接收 Interac 電子轉賬：",
    etransfer3: "發件人",
    etransfer4: "•	提供收件人的姓名和電子郵件地址/手機",
    etransfer5: "•	輸入一個只有收件人才能回答的安全問題",
    etransfer6: "•	指定付款金額和所需帳戶",
    etransfer7: "•	電子郵件通知將自動發送給收件人",
    etransfer8: "收件人",
    etransfer9: "•	使用電子郵件或短信通知中的鏈接，您可以訪問安全的網上銀行頁面",
    etransfer10: "•	回答您的安全問題並將資金存入您的一個賬戶",
    president:"會長",
    vicePresident:"副會長",
    treasurer:"財政",
    enSecretary:"英文袐書",
